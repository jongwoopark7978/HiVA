...
def train(cfg: TrainPipelineConfig, accelerator: Accelerator | None = None):
    ...
    # Build the policy directly on this rank's accelerator device. Passing a
    # generic "cuda" to make_policy() makes every distributed rank allocate on
    # cuda:0 before accelerator.prepare(), which can OOM rank 0 during startup.
