...
from lerobot.policies.smolvla_hiva_coeff.configuration_smolvla_hiva_coeff import HiVACoeffSmolVLAConfig
...
def make_policy_config(policy_type: str, **kwargs) -> PreTrainedConfig:
    ...
    elif policy_type == "smolvla_hiva_coeff":
        return HiVACoeffSmolVLAConfig(**kwargs)
