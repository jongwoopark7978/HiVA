...
DURATION_CLEAN_LOSS_WEIGHT="${DURATION_CLEAN_LOSS_WEIGHT:--1.0}"
...
echo "DURATION_CLEAN_LOSS_WEIGHT=${DURATION_CLEAN_LOSS_WEIGHT}"
...
"${ACCELERATE_BIN}" launch \
  ...
  --policy.duration_clean_loss_weight="${DURATION_CLEAN_LOSS_WEIGHT}" \
