...
# Fan out selected P5/P7 stage0 LP-MT checkpoint evals on GPU 5.
...
P5_EVAL_DIR="${P5_EVAL_DIR:-${REPO_ROOT}/outputs/eval/bigbrain_gpu5_${P5_MODEL_NAME}_10eps_bs${EVAL_BATCH_SIZE}_${TIMESTAMP}}"
P7_EVAL_DIR="${P7_EVAL_DIR:-${REPO_ROOT}/outputs/eval/bigbrain_gpu5_${P7_MODEL_NAME}_10eps_bs${EVAL_BATCH_SIZE}_${TIMESTAMP}}"

LOG_DIR="${REPO_ROOT}/outputs/eval_logs"
mkdir -p "${LOG_DIR}"
QUEUE_LOG="${QUEUE_LOG:-${LOG_DIR}/eval_stage0_p5_p7_selected_ckpts_fanout_gpu${GPU_ID}_bs${EVAL_BATCH_SIZE}_${TIMESTAMP}.queue.log}"
...
main() {
  ...
  require_dir "${P5_TRAIN_DIR}/checkpoints"
  require_dir "${P7_TRAIN_DIR}/checkpoints"

  local p5_ckpts=(001875 002000 002500 003000 003125 003500)
  local p7_ckpts=(001875 002000 002500 003000 003125)

  echo "===== stage0 P5/P7 selected checkpoint fanout eval started at $(date) ====="
  echo "TIMESTAMP=${TIMESTAMP}"
  echo "GPU_ID=${GPU_ID}"
  echo "EVAL_BATCH_SIZE=${EVAL_BATCH_SIZE}"
  echo "P5_TRAIN_DIR=${P5_TRAIN_DIR}"
  ...
  echo "===== stage0 P5/P7 selected checkpoint fanout eval finished at $(date) ====="
}
