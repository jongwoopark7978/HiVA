...
mkdir -p "${LOG_DIR}"
QUEUE_LOG="${QUEUE_LOG:-${LOG_DIR}/eval_stage0_extra_ckpts_003750_005000_fanout_gpu6_7_bigbrain_bs${EVAL_BATCH_SIZE}_${TIMESTAMP}.queue.log}"
...
main() {
  ...
  local ckpts=(003750 004375 005000)
  local gpus=(6 7 6)
