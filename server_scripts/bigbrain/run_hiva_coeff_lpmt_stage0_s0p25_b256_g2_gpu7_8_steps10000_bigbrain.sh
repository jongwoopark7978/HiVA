...
# degree-3 k10_f15 run, but with S=0.25 and doubled total steps on GPUs 7,8.
...
SAVE_STEPS="${SAVE_STEPS:-[5000,6000,6250,7000,7500,8750,10000]}"
RUN_NAME="${RUN_NAME:-smolvla_hiva_coeff_lpmt_stage0_v5_d4_6_10_coeffpool_full_ce_mean_k10_f15_bigbrain_b256_g2_s0p25_steps10000_${RUN_STAMP}}"
QUEUE_LOG="${QUEUE_LOG:-${LOG_DIR}/hiva_coeff_lpmt_stage0_s0p25_b256_g2_gpu7_8_steps10000_bigbrain_${RUN_STAMP}.log}"
...
WANDB_NOTES="${WANDB_NOTES:-BestS0p5-style degree3 k10_f15 BigBrain run with S=0.25; GPUs=7,8; batch_per_gpu=256; effective_batch=512; steps=10000; save_steps=${SAVE_STEPS}}" \
