...
# Partial LIBERO eval for stage1 xattn b9 v5 d4,6,10 LP-MT residual checkpoint.
...
POLICY_PATH="${POLICY_PATH:-/home/jongwoopark/lerobot/outputs/train/smolvla_hiva_coeff_lpmt_residual_stage1_xattn_b9_v5_d4_6_10_k10_f15_scale1p0_daw1p0_b128_s2_20260511_214458_scale1p0_daw1p0/checkpoints/last/pretrained_model}"
...
CHECKPOINT_LABEL="${CHECKPOINT_LABEL:-job1_lpmt_stage1_xattn_b9_v5_d4_6_10_scale1p0_daw1p0_b128_k10_f15_10eps_bs${EVAL_BATCH_SIZE}}"
...
echo "===== stage1 xattn b9 scale1.0 DAW1.0 eval started at $(date) ====="
...
echo "===== stage1 xattn b9 scale1.0 DAW1.0 eval finished at $(date) ====="
