...
TIMESTAMP="${TIMESTAMP:-$(date +%Y%m%d_%H%M%S)_b18_earlyckpt_gpu4_7}"
TRAIN_DIR="${TRAIN_DIR:-/home/jongwoopark/lerobot/outputs/train/smolvla_hiva_coeff_lpmt_residual_stage1_xattn_b18_v5_d4_6_10_k10_f15_tr3p0_rot3p0_grip0p0_daw1p0_trb0p1_rotb0p05_gripb0p1_b1024_g4_s1_earlyckpt_20260513_180325}"
MODEL_TAG="${MODEL_TAG:-b18_s1_earlyckpt_tr3_rot3_grip0_rotb0p05}"
CKPTS="${CKPTS:-000032 000044 000050 000057 000063 000069 000075 000079 000094 000110 000125 last}"
