...
TRAIN_DAW2P0="/home/jongwoopark/lerobot/outputs/train/smolvla_hiva_coeff_lpmt_residual_flow_stage1_v5_d4_6_10_k10_f15_tr3p0_rot3p0_grip0p5_daw2p0_b128_g8_s2_20260514_040554"
TRAIN_DAW0P5="/home/jongwoopark/lerobot/outputs/train/smolvla_hiva_coeff_lpmt_residual_flow_stage1_v5_d4_6_10_k10_f15_tr3p0_rot3p0_grip0p5_daw0p5_b128_g8_s2_20260514_040554"
...
echo "===== Follow-up LPMT residual-flow GPU0-3 eval queue started at $(date) ====="
...
echo "===== Follow-up LPMT residual-flow GPU0-3 eval queue finished at $(date) ====="
