...
echo "===== LPMT residual-flow GPU0-3 eval queue started at $(date) ====="
...
run_group \
  "${TRAIN_LPMT}" \
  "lpmt_residual_flow_v5_d4_6_10_tr3_rot3_grip0p5_b128_g8_s2_gpu0_3" \
  "${CKPTS_LPMT[@]}"

echo "===== LPMT residual-flow GPU0-3 eval queue finished at $(date) ====="
