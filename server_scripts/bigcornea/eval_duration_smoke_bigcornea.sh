...
MASTER_LOG="${LOG_DIR}/eval_duration_smoke_bigcornea_${TIMESTAMP}.log"
...
RUN_NAME="duration_bigcornea_smoke_${TASK_NAME}_taskids_${TASK_IDS//[^0-9A-Za-z_-]/_}_${TIMESTAMP}"
...
echo "Duration bigcornea smoke eval finished."
