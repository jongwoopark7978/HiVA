...
mkdir -p "${LOG_DIR}"
LOG_FILE="${LOG_FILE:-${LOG_DIR}/run_hiva_residual_stage1_only_bigcornea_${RUN_STAMP}.log}"
...
OUTPUT_ROOT="${OUTPUT_ROOT:-${SIDECAR_ROOT}/HiVA_train}"
...
RUN_NAME="${RUN_NAME:-smolvla_hiva_coeff_lpmt_residual_stage1_only_v5_d4_6_10_k${HIVA_K}_f${HIVA_FIT_HORIZON}_daw${HIVA_DECODED_ACTION_LOSS_WEIGHT//./p}_b${BATCH_PER_GPU}_s${S}_${RUN_STAMP}}"
