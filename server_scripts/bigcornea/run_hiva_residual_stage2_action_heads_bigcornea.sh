...
# Standalone Stage-2 co-adaptation finetune for LP-MT residual HiVA v5 on bigcornea.
#
...
mkdir -p "${LOG_DIR}"
LOG_FILE="${LOG_FILE:-${LOG_DIR}/run_hiva_residual_stage2_action_heads_bigcornea_${RUN_STAMP}.log}"
