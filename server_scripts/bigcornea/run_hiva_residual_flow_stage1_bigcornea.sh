...
# on bigcornea. Defaults are intentionally tiny and GPU4-only for smoke testing. Override
...
mkdir -p "${LOG_DIR}"
LOG_FILE="${LOG_FILE:-${LOG_DIR}/run_hiva_residual_flow_stage1_bigcornea_${RUN_STAMP}.log}"
...
INIT_HIVA_BASE="${INIT_HIVA_BASE:-/nfs/bigcornea/add_disk2/jongwoopark/HiVA_train/BestS2_smolvla_hiva_coeff_lpmt_coeffpool_job1_v5_d4_6_10_full_ce_mean_k10_f15_bigcornea_b64_s2_20260510_041334/checkpoints/last/pretrained_model}"
...
RUN_NAME="${RUN_NAME:-smolvla_hiva_coeff_lpmt_residual_flow_stage1_bigcornea_smoke_gpu${GPU_IDS//,/}_b${BATCH_PER_GPU}_steps${STEPS}_${RUN_STAMP}}"
