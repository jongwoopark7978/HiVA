...
# with S=0.25 and dense milestone checkpoints for early/intermediate selection.
...
import math
steps = int("${STEPS}")
fractions = (0.25, 0.3, 0.35, 0.375, 0.4, 0.5, 0.6, 0.625, 0.7, 0.75, 0.875, 1.0)
...
echo "Stage-0 LP-MT HiVA v5 S=0.25 milestone finetune"
