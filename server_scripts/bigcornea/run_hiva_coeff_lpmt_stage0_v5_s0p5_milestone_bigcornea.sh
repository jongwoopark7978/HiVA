...
# with a longer S=0.5 schedule and dense milestone checkpoints.
...
import math
steps = int("${STEPS}")
fractions = (0.1, 0.25, 0.3, 0.375, 0.4, 0.5, 0.6, 0.625, 0.7, 0.75, 0.875, 1.0)
...
echo "Stage-0 LP-MT HiVA v5 milestone finetune"
